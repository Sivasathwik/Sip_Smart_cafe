...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-wnj7r)uh^q9b_f-di*3y$_@d!i5dsa@a*sn36+&u5a=d4j0$9h',
)
...
ALLOWED_HOSTS = [
    host.strip()
    for host in os.environ.get('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,testserver,.vercel.app').split(',')
    if host.strip()
]
...
AUTH_USER_MODEL = 'coffes.User'

# Custom authentication backend for email login
AUTHENTICATION_BACKENDS = [
    'coffes.backends.EmailBackend',
...
CSRF_TRUSTED_ORIGINS = [
    origin.strip()
    for origin in os.environ.get('DJANGO_CSRF_TRUSTED_ORIGINS', 'https://*.vercel.app').split(',')
    if origin.strip()
]
